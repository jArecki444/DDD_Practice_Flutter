...
@injectable
class NoteFromBloc extends Bloc<NoteFromEvent, NoteFormState> {
  final INoteRepository _noteRepository;

  NoteFromBloc(this._noteRepository) : super(NoteFormState.initial()) {
    on<NoteFromEvent>((event, emit) async {
      await event.map(
